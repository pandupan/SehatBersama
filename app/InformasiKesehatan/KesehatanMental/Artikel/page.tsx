      ...
      <div className="border-b-2 pb-4">
        ...
        <div className="flex items-centerjustify-between">
            ...
            <div className="my-auto">
                <a href="/InformasiKesehatan/KesehatanMental" className="bg-[#1dbbb4] rounded-md text-white sm:text-base text-xs px-2 py-2 sm:px-10 sm:py-2">
                  Kembali
                </a>
            </div>
        </div>
      ...
      <div className="mt-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-2 text-center">
            <b>Gambar 1</b> <span className="italic">Mental Health</span>
          </p>
        </div>
        <div className="mt-4 mb-6 space-y-2">
          <h3 className="text-xl sm:text-2xl font-bold">Generasi Z</h3>
        ...
        <div className="mt-4 mb-6 space-y-2">
          <h3 className="text-xl sm:text-2xl font-bold">Generasi Z yang tumbuh di era digital</h3>
          <p className="text-gray-600 text-justify">
        ...
        <div className="mt-4 mb-6 space-y-2">
          <h3 className="text-xl sm:text-2xl font-bold">Generasi Z yang hidup di era digital</h3>
          <p className="text-gray-600 text-justify">
        ...
        <div className="mt-4 mb-6 space-y-2">
          <h3 className="text-xl sm:text-2xl font-bold">Aspek kepercayaan diri</h3>
          <p className="text-gray-600 text-justify">
